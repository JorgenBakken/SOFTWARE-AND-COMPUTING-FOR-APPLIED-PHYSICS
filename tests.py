...
@given(t=st.floats(min_value=-100, max_value=100),
    ...
    fence=st.booleans())
@settings(max_examples=50)
def test_eight_component_w_RHS_output(t, theta, omega, fence):
    """
    Test the output dtype of the eight_component_w_RHS function.
...
@given(t=st.floats(min_value=-100, max_value=100),
    ...
    fence=st.booleans())
@settings(max_examples=50)
def test_eight_component_w_RHS_extended_output_size(t, theta, omega, fence):
    """
    Test the output size of the eight_component_w_RHS_extended function.
